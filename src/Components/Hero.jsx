...
const Hero = () => {
  return (
    <div className="flex flex-col items-center gap-6 py-20 px-4 sm:px-12 lg:px-24 xl:px:40 text-center w-full overflow-hidden text-shadow-gray-700 dark:text-white">
      <motion.div
      ...
      <motion.p
        ...
        viewport={{ once: true }}
        className="text-sm sm:text-lg font-medium text-gray-500 dark:text-white/75 max-w-4/5 sm:max-lg pb-3"
      >

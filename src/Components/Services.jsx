  ...
  const servicesData = [
    {
      title: "Advertising",
      description:
        "we turn bold idea into powerful digital solution that connect, engage.....",
  ...
  return (
    ...
    >
      ...
      <Title
        ...
        desc={
          "From stratgy to execution, we craft digital solutions that move your business forward"
        }
      />
